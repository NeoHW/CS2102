...
CREATE TABLE IF NOT EXISTS stages (
 nr INTEGER PRIMARY KEY, -- index
 day DATE UNIQUE NOT NULL,
 start VARCHAR(64) NOT NULL, -- start location name
 finish VARCHAR(64) NOT NULL, -- finish location name
 length NUMERIC(5,1) NOT NULL, -- in km
 type VARCHAR(32),
...
CREATE TABLE IF NOT EXISTS sprints (
 stage INTEGER NOT NULL, -- stages.index
...
CREATE TABLE IF NOT EXISTS results_individual (
 ...
 time INTEGER NOT NULL CHECK (time >= 0), -- in seconds
